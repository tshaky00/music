...
- أوامر المستخدمين: 
• {HNDLR}بحث [عنوان المقطع | رابط يوتيوب | الرد على ملف مقطع صوتي] - لتشغيل مقطع صوتي في المكالمه
...
• {HNDLR}الاوامر - لعرض اوامر سورس ميوزك ماغي 

- أوامر المشرفين  : 
• {HNDLR}استئناف - لمواصلة تشغيل المقطع الصوتي أو الفيديو المتوقف

• {HNDLR}توقف - لإيقاف تشغيل المقطع الصوتي أو مقطع فيديو مؤقتًا

• {HNDLR}تخطي - لتخطي المقطع الصوتي أو الفيديو الحالي وتشغيل ما بعده

• {HNDLR}ايقاف - لإنهاء التشغيل

• {HNDLR} تحميل + اسم الاغنية - لتحميل اغنية من اليويتوب 

• {HNDLR} فيد + اسم الفيديو - لتنزيل فيديو من اليوتيوب
"""
    await m.reply(HEPZ)
